...
export const VARIABLES = {
  ...
  ph: {
    ...
    diffStops: [
      [-0.15, '#c81414'],   // pH dropped = acidification (bad)
      [-0.05, '#e66e14'],
      [-0.01, '#f0c878'],
      [ 0,    '#f5f5f5'],
      [ 0.01, '#a0d2e6'],
      [ 0.05, '#3c78d2'],
      [ 0.15, '#5037b4'],   // pH rose = less acidic (good)
    ],
    gradient: 'linear-gradient(90deg,#a01414,#d25a0f,#c8be28,#50b450,#3c78d2,#5037b4)',
    diffGrad: 'linear-gradient(90deg,#c81414,#e66e14,#f0c878,#f5f5f5,#a0d2e6,#3c78d2,#5037b4)',
    accent: '#a78bfa',
